...
public class KutuSilActivity extends Activity {

    private KutuSilView ksView;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.kutusil);
        ksView = (KutuSilView) findViewById(R.id.tahta);
