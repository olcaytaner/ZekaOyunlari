...
public class SatrancTaslariActivity extends Activity {

    private SatrancTaslariView stView;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.satranctaslari);
        stView = (SatrancTaslariView) findViewById(R.id.tahta);
