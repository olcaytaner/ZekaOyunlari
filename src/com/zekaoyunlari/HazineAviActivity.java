...
public class HazineAviActivity extends Activity {

    private HazineAviView haView;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.hazineavi);
        haView = (HazineAviView) findViewById(R.id.ada);
